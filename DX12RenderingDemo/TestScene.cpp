...
void CTestScene1::BuildObjects(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList)
{
...
void CTestScene2::BuildObjects(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList)
{
    mGraphicsRootSignature = CreateGraphicsRootSignature(device);
