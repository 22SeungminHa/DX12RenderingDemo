...
public:
    ...
    RenderTexture& GetSceneColorTarget() { return sceneColor_; }
...
private:
    ...
    RtvDescriptorAllocation sceneColorRtv_;
    RtvDescriptorAllocation brightColorRtv_;
    RtvDescriptorAllocation blurTempRtv_;
